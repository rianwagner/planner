...
from app.controllers.materia_controller import listar_materias, obter_materia, criar_materia, deletar_materia
from app.controllers.trabalho_controller import listar_trabalhos, obter_trabalho, criar_trabalho, deletar_trabalho
from app.controllers.prova_controller import listar_provas, obter_prova, criar_prova, deletar_prova
...
app.add_url_rule('/materias/<int:id>', 'get_materia', obter_materia, methods=['GET'])  # Corrigido
